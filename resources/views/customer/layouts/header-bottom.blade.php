        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="navbar" aria-labelledby="main-navigation">
            ...
            <div class="offcanvas-body">
                <ul x-data="menu()" class="navbar-nav me-auto flex-grow-1">
                    @include('eshop::customer.layouts.menu-items.menu-item-1')
                    @include('eshop::customer.layouts.menu-items.menu-item-2')
                    @include('eshop::customer.layouts.menu-items.menu-item-3')
                    @include('eshop::customer.layouts.menu-items.menu-item-4')
                    @include('eshop::customer.layouts.menu-items.menu-item-5')
                    @include('eshop::customer.layouts.menu-items.menu-item-6')
                </ul>

                <div class="d-none d-lg-flex align-items-center">
                    <a href="#" class="btn btn-sm btn-outline-light rounded-pill">{{ __("Track your order") }}</a>
                </div>
            </div>
        </div>
    </div>
