            ...
            <div class="row gx-0 gx-xl-3">
                <div class="col d-flex flex-column gap-3 order-1">
                    <div class="d-flex align-items-baseline">
                        <h1 class="fs-4 mb-0">{{ __($collection->name) }}</h1>
                    ...
                    <div class="d-flex gap-2">
                        @foreach($selectedManufacturers as $manufacturer)
                            <a href="{{ route('products.collections.index', array_filter([app()->getLocale(), $collection->slug, 'manufacturer_ids' => $selectedManufacturers->toggle($manufacturer)->pluck('id')->join('-'), 'min_price' => request()->query('min_price'), 'max_price' => request()->query('max_price')])) }}" class="btn btn-smoke px-2 py-0 d-flex gap-2 align-items-center">
