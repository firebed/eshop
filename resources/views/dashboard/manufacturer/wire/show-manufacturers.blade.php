<div class="col-12 col-xxl-8 p-4 mx-auto d-grid gap-3">
    <h1 class="fs-3 mb-0">{{ __("Manufacturers") }}</h1>
    ...
    <x-bs::card>
        <div class="table-responsive">
            @include('eshop::dashboard.manufacturer.partials.manufacturers-table')
        </div>
    </x-bs::card>

    <form wire:submit.prevent="save">
        @include('eshop::dashboard.manufacturer.partials.manufacturer-modal')
    </form>
        ...
        <x-bs::modal wire:model.defer="showConfirmDelete">
            <x-bs::modal.body>
                <div class="d-grid gap-3 text-center">
                    ...
                    <div class="text-secondary">{{ __("Are you sure you want to delete the selected manufacturers? This action cannot be undone.") }}</div>
                    <div>
