<div class="position-relative card shadow-sm">
    ...
    <div class="card-body">
        ...
        @else
            <div class="btn-group w-100">
                @if($currentVoucher !== null)
                    <a class="btn btn-primary" href="#" wire:click.prevent="editVoucher({{ $currentVoucher->id }})"><em class="fas fa-pencil-alt me-2"></em> Επεξεργασία</a>
                    <a class="btn btn-smoke" href="#" wire:click.prevent="$toggle('showDeleteVoucherModal')"><em class="fas fa-trash-alt text-secondary me-2"></em> Διαγραφή</a>
                @else
                    <a class="btn btn-primary" href="#" wire:click.prevent="createVoucher()"><em class="fas fa-pencil-alt me-2"></em> Έκοδση voucher</a>
                @endif
            </div>
        @endif
    </div>
