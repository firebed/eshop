    ...
    <div class="card-body">
        <div class="btn-group w-100">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="#"><em class="fas fa-pencil-alt text-secondary me-2"></em> Χειροκίνητη εισαγωγή</a></li>
                <li>
                    <hr class="dropdown-divider">
                </li>
                <li><a class="dropdown-item" href="#"><em class="fas fa-trash-alt text-secondary me-2"></em> Διαγραφή voucher</a></li>
            </ul>
        </div>
    </div>
