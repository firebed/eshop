<div class="col-12 col-xxl-10 p-4 mx-auto d-grid gap-3">
    <h1 class="fs-3 mb-0">{{ __("Shipping options") }}</h1>
        ...
        <x-bs::modal wire:model.defer="showConfirmDelete">
            <x-bs::modal.body>
                <div class="d-grid gap-3 text-center">
                    ...
                    <div class="text-secondary">{{ __("Are you sure you want to delete the selected shipping methods? This action cannot be undone.") }}</div>
                    <div>
