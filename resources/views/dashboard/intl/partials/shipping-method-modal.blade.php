<form wire:submit.prevent="save">
    <x-bs::modal wire:model.defer="showEditingModal">
        <x-bs::modal.header>{{ __('Edit shipping method') }}</x-bs::modal.header>
        <x-bs::modal.body>
            <div class="d-grid gap-3">
                ...
                <div class="row g-3">
                    ...
                    <x-bs::input.group for="method" label="{{ __('Method') }}" class="col-6">
                        <x-bs::input.select wire:model.defer="model.shipping_method_id" error="model.shipping_method_id" id="method">
                            <option value="" disabled>{{ __('Shipping method') }}</option>
                            @isset($methods)
                ...
                <div class="row g-2">
                    <x-bs::input.group for="weight-limit" label="{{ __('Weight limit') }}" class="col">
                        <x-bs::input.weight wire:model.defer="model.weight_limit" error="model.weight_limit" id="weight-limit"/>
                    </x-bs::input.group>

                    <x-bs::input.group for="weight-excess-fee" label="{{ __('Weight excess fee') }}" class="col">
                        <x-bs::input.money wire:model.defer="model.weight_excess_fee" error="model.weight_excess_fee" id="weight-excess-fee"/>
                    </x-bs::input.group>

                    <x-bs::input.group for="inaccessible-area-fee" label="{{ __('Inaccessible area fee') }}" class="col">
                        <x-bs::input.money wire:model.defer="model.inaccessible_area_fee" error="model.inaccessible_area_fee" id="inaccessible-area-fee"/>
                    </x-bs::input.group>
                </div>
