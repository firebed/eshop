@extends('layouts.master', ['title' =>  __('Shipping address')])
                        ...
                        <div class="row row-cols-1 row-cols-lg-2 gx-5 gy-4">
                            <div class="col flex-grow-1">
                                <div class="d-grid gap-4 align-items-start">
                                    @include('checkout.details.partials.checkout-details-shipping-addresses')
                                    @include('checkout.details.partials.checkout-details-invoicing')
                            ...
                            <div class="col w-lg-25r align-self-start sticky-md-top" style="top: 2rem">
                                @include('checkout.details.partials.checkout-details-summary')
                            </div>
                        </div>
