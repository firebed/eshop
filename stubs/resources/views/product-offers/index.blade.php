                ...
                <div class="col d-flex flex-column gap-3">
                    ...
                    <div class="d-flex gap-2">
                        @foreach($selectedManufacturers as $manufacturer)
                            <a href="{{ route('products.offers.index', ['$manufacturer_ids' => $selectedManufacturers->toggle($manufacturer), request()->query('min_price'), request()->query('max_price')]) }}" class="btn btn-smoke px-2 py-0 d-flex gap-2 align-items-center">
