...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'attachment.title'           => ['nullable', 'required_with:attachment.file', 'string'],
            'attachment.file'            => ['nullable', 'required_with:attachment.title', 'file', 'mimetypes:application/pdf,image/jpeg,image/png,image/gif', 'max:3072'],
