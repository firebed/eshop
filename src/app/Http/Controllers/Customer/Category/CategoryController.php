...
use App\Http\Controllers\Customer\Category\Traits\ValidatesCategoryUrl;
...
class CategoryController extends Controller
{
    ...
    public function __invoke(CustomerCategoryRequest $request, string $locale, Category $category): Renderable|RedirectResponse
    {
        ...
        return view('customer.category.show', compact('breadcrumb', 'category', 'manufacturers', 'filters', 'priceRanges', 'products'));
    }
