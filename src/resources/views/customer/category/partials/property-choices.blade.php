            ...
            <div class='d-flex flex-column filters'>
                <div class='d-flex mb-3'>
                    ...
                    @if ($filters['c']->contains('property.id', $property->id))
                        <a href='{{ categoryRoute($category, $filters['m'], $filters['c']->reject(fn($v) => $v->property->id === $property->id), $filters['min_price'], $filters['max_price']) }}' class='small ms-3'>{{ __('Cancel') }}</a>
                    @endif
                </div>
