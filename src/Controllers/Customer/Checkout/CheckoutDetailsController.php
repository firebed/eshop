...
//        $order->load('products.parent.translation', 'products.translation', 'products.options');
        ...
        return view('eshop::customer.checkout.details.edit', [
            'order'                 => $order,
            'products'              => $products,
    ...
    public function shippingCountry(Request $request, Order $order, RefreshOrder $refreshOrder): JsonResponse
    {
        ...
        $summary = view('eshop::customer.checkout.details.partials.checkout-details-summary', [
            'order'                 => $order,
            'products'              => $products,
        ...
        $provinces = view('eshop::customer.checkout.details.partials.provinces', [
            'shipping'  => $order->shippingAddress,
            'provinces' => $provinces,
        ])->render();
